...
const optionTitles: Record<string, string> = {
  ...
  nutrition: 'Nutrición',
  perfusion: 'Perfusión tisular y oxigenación'
};
  ...
  const renderScoreSummary = () => (
    <View style={styles.modalView}>
      ...
      <View style={styles.scoreSection}>
        ...
        <Text style={styles.scoreMax}>de 28 puntos</Text>
      </View>
      ...
      <View style={styles.modalView}>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.selectedOptionsContainer}>
            ...
            <Text style={styles.totalScore}>Puntaje Total: {score} de 28 puntos</Text>
